...
export default ({ fills={}, fallback='orange', onClick })=>(
  <svg viewBox="0 0 959 593">
    <path fill={fills.AK || fallback} onClick={()=> onClick('AK')}
    ...
    <path fill={fills.HI || fallback} onClick={()=> onClick('HI')}
    ...
    <path fill={fills.AL || fallback} onClick={()=> onClick('AL')}
    ...
    <path fill={fills.AR || fallback} onClick={()=> onClick('AR')}
    ...
    <path fill={fills.AZ || fallback} onClick={()=> onClick('AZ')}
    ...
    <path fill={fills.CA || fallback} onClick={()=> onClick('CA')}
    ...
    <path fill={fills.CO || fallback} onClick={()=> onClick('CO')}
          d="M380.2 235.5l-36-3.5-79.1-8.6-2.2 22.1-7 50.4-1.9 13.7 34 3.9 37.5 4.4 34.7 3 14.3.6z"/>
    
    <path fill={fills.CT || fallback} onClick={()=> onClick('CT')}
    ...
    <path fill={fills.DE || fallback} onClick={()=> onClick('DE')}
    ...
    <path fill={fills.FL || fallback} onClick={()=> onClick('FL')}
    ...
    <path fill={fills.GA || fallback} onClick={()=> onClick('GA')}
    ...
    <path fill={fills.IA || fallback} onClick={()=> onClick('IA')}
    ...
    <path fill={fills.ID || fallback} onClick={()=> onClick('ID')}
    ...
    <path fill={fills.IL || fallback} onClick={()=> onClick('IL')}
    ...
    <path fill={fills.IN || fallback} onClick={()=> onClick('IN')}
    ...
    <path fill={fills.KS || fallback} onClick={()=> onClick('KS')}
    ...
    <path fill={fills.KY || fallback} onClick={()=> onClick('KY')}
    ...
    <path fill={fills.LA || fallback} onClick={()=> onClick('LA')}
    ...
    <path fill={fills.MA || fallback} onClick={()=> onClick('MA')}
    ...
    <path fill={fills.MD || fallback} onClick={()=> onClick('MD')}
    ...
    <path fill={fills.ME || fallback} onClick={()=> onClick('ME')}
    ...
    <path fill={fills.MI || fallback} onClick={()=> onClick('MI')}
    ...
    <path fill={fills.MN || fallback} onClick={()=> onClick('MN')}
    ...
    <path fill={fills.MO || fallback} onClick={()=> onClick('MO')}
    ...
    <path fill={fills.MS || fallback} onClick={()=> onClick('MS')}
    ...
    <path fill={fills.MT || fallback} onClick={()=> onClick('MT')}
    ...
    <path fill={fills.NC || fallback} onClick={()=> onClick('NC')}
    ...
    <path fill={fills.ND || fallback} onClick={()=> onClick('ND')}
    ...
    <path fill={fills.NE || fallback} onClick={()=> onClick('NE')}
    ...
    <path fill={fills.NH || fallback} onClick={()=> onClick('NH')}
    ...
    <path fill={fills.NJ || fallback} onClick={()=> onClick('NJ')}
    ...
    <path fill={fills.NM || fallback} onClick={()=> onClick('NM')}
    ...
    <path fill={fills.NV || fallback} onClick={()=> onClick('NV')}
    ...
    <path fill={fills.NY || fallback} onClick={()=> onClick('NY')}
    ...
    <path fill={fills.OH || fallback} onClick={()=> onClick('OH')}
    ...
    <path fill={fills.OK || fallback} onClick={()=> onClick('OK')}
    ...
    <path fill={fills.OR || fallback} onClick={()=> onClick('OR')}
    ...
    <path fill={fills.PA || fallback} onClick={()=> onClick('PA')}
    ...
    <path fill={fills.SD || fallback} onClick={()=> onClick('SD')}
    ...
    <path fill={fills.TN || fallback} onClick={()=> onClick('TN')}
    ...
    <path fill={fills.TX || fallback} onClick={()=> onClick('TX')}
    ...
    <path fill={fills.UT || fallback} onClick={()=> onClick('UT')}
    ...
    <path fill={fills.VA || fallback} onClick={()=> onClick('VA')}
    ...
    <path fill={fills.VT || fallback} onClick={()=> onClick('VT')}
    ...
    <path fill={fills.WA || fallback} onClick={()=> onClick('WA')}
    ...
    <path fill={fills.WI || fallback} onClick={()=> onClick('WI')}
    ...
    <path fill={fills.WV || fallback} onClick={()=> onClick('WV')}
